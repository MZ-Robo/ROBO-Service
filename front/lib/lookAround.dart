...
class _LookAroundState extends State<LookAround> {
  ...
  Widget _letter(String title, String hashTag, String imgUrl) {
    return Container(
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      _letter('초보 주식 투자자가 갖는 4가지 착각에 대하여',
                          '#현명한 주식 투자 마인드 #투자 습관', 'assets/letter1.png'),
                      _letter('주식 초보를 위한 투자 주의사항', '#투자 법칙 #투자 주의사항',
                          'assets/letter2.png'),
                    ],
                  ),
                ),
